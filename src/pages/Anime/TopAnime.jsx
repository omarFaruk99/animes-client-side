    ...
    if (loading) return (
        <div className="min-h-screen flex items-center justify-center bg-[#0B1622]">
            <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-violet-300 animate-pulse font-medium">Loading top anime...</p>
            </div>
        </div>
    );
    ...
    return (
        <div className="min-h-screen bg-[#0B1622] text-white pb-16">
            ...
            <div className="relative py-20 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-b from-violet-900/20 via-[#0B1622] to-[#0B1622]"></div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <select
                                ...
                                className="w-full bg-white/10 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-violet-500 focus:border-violet-500"
                            >
